...
namespace AdvancedSceneManager.Core
{
    ...
    public abstract class SceneLoader
    {
        ...
        [Obsolete("Unintuative name as its used for both scene load and unload operations. Use CanHandleScene instead.")]
        public virtual bool CanOpen(Scene scene) => CanHandleScene(scene);
