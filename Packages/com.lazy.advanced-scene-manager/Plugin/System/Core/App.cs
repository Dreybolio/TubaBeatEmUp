...
namespace AdvancedSceneManager.Core
{
    ...
    public readonly struct StartupLoadProgressData : ILoadProgressData
    {
        public StartupLoadProgressData(float value, string phase, Scene scene, SceneCollection collection = null, UnityEngine.SceneManagement.Scene? unityScene = null)
        {
            this.value = value;
            this.phase = phase;
        ...
        public UnityEngine.SceneManagement.Scene? UnityScene { get; }
    ...
    public sealed class App : DependencyInjection.IApp
    {
        ...
        IEnumerator CloseAllScenes(StartupProps _)
        {
            ...
            foreach (var scene in scenes)
            {
                ...
                if (!FallbackSceneUtility.IsFallbackScene(scene) && !isSplash)
                {
#if UNITY_EDITOR
