...
//Used for RegisterCallbackOnce, which only exists in Unity 6, so we have a proxy one
...
namespace AdvancedSceneManager.Editor
{
    ...
    public partial class SceneField : ObjectField, INotifyValueChanged<Scene>
    {
        ...
        public SceneField()
        {
            ...
            PopupView.onPopupClose += SetupTooltip;
            this.RegisterCallbackOnce<DetachFromPanelEvent>(e =>
            {
                PopupView.onPopupClose -= SetupTooltip;
            });
