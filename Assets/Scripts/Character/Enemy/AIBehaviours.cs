...
public class AIBehaviours : MonoBehaviour
{
    ...
    // Constants
    private float COVER_EXIT_MIN_DIST = 2.5f;
    private float COVER_EXIT_MAX_DIST = 3.5f;
    private float COVER_EXIT_FAR_MIN_DIST = 3.5f;
    ...
    public AI_Decision MakeDecision(AI_SquadRole role, int aiDifficulty)
    {
        ...
        // Far away enough from target, do movement
        switch (role)
        {
            case AI_SquadRole.OFFENSE:
            ...
            case AI_SquadRole.COVER_EXIT:
                ...
                break;
            case AI_SquadRole.COVER_EXIT_FAR:
                // Try to stand on either side of the player
                ...
                break;
            case AI_SquadRole.FLANK:
                break;
            default:
                break;
        }
        // Else, just stand still. Yuo're doing great, sweaty!
        return new AI_Decision { action = AI_Action.IDLE };
    }
